...
if (Messages.find().count() === 0) {
    ...
    var userNames = ['Data','Picard','Geordi','Worf','Riker'];
    var roomNames = ['The Bridge','Ten Forward','Sickbay'];
    ...
    for (var i = 0; i < userNames.length; i++) {
        ...
        users.push(Meteor.users.findOne(userId));
    }

    var rooms = [];
    for (var i = 0; i < roomNames.length; i++) {
        rooms.push(Rooms.insert({
            name: roomNames[i]
        }));
    }
