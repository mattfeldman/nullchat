    ...
    switch (args[0]) {
        ...
        case "meme":
            ...
            if (!memeMatch || memeMatch.length < 4) {
                ...
                var topLine = memeMatch[2].replace(new RegExp(' ','g'), '-');
                var bottomLine = memeMatch[3].replace(new RegExp(' ','g'), '-');
                var memeUrl = "https://upboat.me/" + memeMatch[1] + "/" + topLine + "/" + bottomLine + ".jpg";
